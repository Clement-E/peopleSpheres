...
import {formatedDateInThirtyDays, getMultiSelected, repeat} from '../../../utils';
...
const ProductForm = (props) => {
    ...
    return (
        <Form onSubmit={onSubmit}>
            ...
            <Button disabled={!isNameValid(name) || !isCategoriesValid(categories)} className="btn-info">Submit</Button>
        </Form>
    );
}
